<template>
  <div class="nc-PageAuthor bg-gray-50/10 dark:!bg-neutral-900 ">
    <div class="w-full">
      <div class="w-full mx-auto xl:max-w-7xl  lg:pt-16">
        <div
          class="relative bg-white dark:!bg-neutral-900 dark:border dark:!border-neutral-700  rounded-t-lg flex flex-col md:flex-row border border-gray-100"
        >
          <div class="w-full lg:w-40 flex-shrink-0 mt-4 sm:mt-0 px-4 lg:p-8 lg:block flex items-center">
            <div
          ...
          <div class="flex-grow lg:mr-6">
            <div class="max-w-full space-y-4">
              ...
              <span
                ...
                >محبوب حسین زاده (زاده ۲۸ اردیبهشت ۱۳۶۹ در خوی) نوازنده، توسعه
              ...
              >
                    ...
                    <div
            class="flex  justify-start px-4 pb-4"
          >
            <button
            ...
            <div class="mx-2">
              ...
              >
                  <Menu as="div" class="relative inline-block">
                        <div>
                          <MenuButton
                            class="flex-shrink-0 flex items-center justify-center focus:outline-none h-9 w-9 bg-neutral-100 hover:bg-neutral-200 dark:!bg-neutral-600 dark:hover:!bg-neutral-700 text-neutral-700 dark:text-neutral-200 rounded-full"
                          >
    ...
    <div
      class="w-full mx-auto  xl:max-w-7xl lg:pb-28 "
    >
      <main>
        <div
          class="flex flex-col sm:items-center sm:justify-between sm:flex-row bg-white  border-b"
        >
          <nav class="nc-Nav p-3">
        ...
        <div
          class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8   p-4 pb-16 rounded-lg bg-white "
        >
          <article>
            <div
              class="relative flex flex-col group rounded-3xl overflow-hidden bg-gray-50 dark:bg-neutral-900 h-full"
            >
              <div
