<template>
  <div class="lg:pb-8">
    <div class="w-full">
      <div
        class="h-24 2xl:h-28 top-0 start-0 right-0 w-full bg-gray-200/50 dark:bg-neutral-900"
      ></div>
      <div class="max-w-7xl mx-auto w-full">
        <header class="max-w-2xl mx-auto -mt-10 flex flex-col lg:-mt-7">
          <form class="relative px-3" action="" method="post">
            <label
              for="search-input"
              class="text-neutral-500 dark:text-neutral-300"
              ><span class="sr-only">Search all</span
              ><input
                class="block w-full border-neutral-200 focus:border-primary-300 focus:ring focus:ring-primary-200/50 bg-white dark:border-neutral-500 dark:focus:ring-primary-500/30 dark:bg-neutral-900  text-sm font-normal pr-14 py-5 pe-5 md:ps-16 shadow-lg rounded-xl border-opacity-0"
                id="search-input"
                placeholder="متن مورد نظرتان را بنویسید و کلید اینتر را بفشارید"
                type="search"
                value="خزنده ها" /><span
          ...
          <span
            class="block text-sm mt-4 text-neutral-500 dark:text-neutral-300 pr-4"
            >ما
            <strong class="font-semibold text-neutral-800 dark:text-neutral-100 font-fd"
              >1135</strong
            >
            نتیجه برای
  ...
  <div
    class="py-16 lg:pb-28 lg:pt-20 space-y-16 lg:space-y-28"
  >
        ...
        <div class="mx-auto w-full xl:max-w-7xl relative">
          ...
          >
            <div class="w-full flex items-center justify-between">
              ...
              >
                <CategoryIcon class="w-12 rounded-lg ml-2 p-2 bg-orange-500" />
