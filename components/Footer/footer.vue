<template>
  <footer class="relative z-0 mx-auto w-full max-w-7xl">
      ...
      <div class="content pb-10 pt-10">
            ...
            >
              <li>
                <a
                  ...
                  rel="nofollow"
                  class="group flex items-center rounded justify-center w-10 h-10 dark:hover:bg-orange-970 dark:bg-orange-800 dark:bg-opacity-25 bg-orange-50 group hover:bg-orange-700 transition duration-300 ease-linear"
                >
                  <svg
                    width="19"
                    height="14"
                  ...
                  >
                    <path
                      class="fill-current transition duration-300 ease-linear dark:text-orange-950 text-orange-700 group-hover:text-white"
              ...
              <li class="mr-2">
                ...
                >
                  ...
                  >
                    <path
                      class="stroke-current transition duration-300 ease-linear dark:text-orange-950 dark:text-orange-950 text-orange-700 group-hover:text-white"
        ...
        <div class="grid md:grid-cols-9 grid-cols-1 xl:gap-20 gap-7">
          <div class="md:col-span-4">
            ...
            >
              <h3
                class="text-xl relative font-bold dark:text-white text-biscay-700 mb-4 z-10"
              >
                درباره پت دانیم
              </h3>
              <span
            ...
            <div class="flex relative">
              <span
                class="md:flex hidden absolute top-1 right-0 w-1 h-1 mt-2 bg-orange-500 opacity-30 rounded-full"
              ></span>
          ...
          <div class="md:col-span-2">
            <div
              class="relative flex md:items-start md:mx-0 mx-auto w-fit-content items-center"
            >
              <h3
                class="text-xl relative font-bold dark:text-white text-biscay-700 mb-4 z-10"
              >
  ...
  <footer class="relative overflow-hidden bg-white hidden">
    <div class="border-gray-200">
      <div
        class="mx-auto px-4 sm:px-6 lg:px-8 w-screen xl:max-w-screen-2xl py-8 lg:py-12"
      >
        ...
        >
          <a
            ...
            ><span class="flex-shrink-0 h-5 w-5" aria-hidden="true">
              <Instagram class="fill-none w-8 stroke-orange-500" /> </span
          ></a>
        </div>
        <div
