<template>
        ...
        <div class="mx-auto w-full xl:max-w-7xl px-6">
            <header class=" relative pt-14 lg:py-20 flex flex-col lg:flex-row lg:items-center">
                    ...
                    <div class="nc-SingleHeader ">
                        <div class="space-y-5  text-neutral-100">
                            <div class="nc-CategoryBadgeList flex flex-wrap space-x-2" data-nc-id="CategoryBadgeList"><a
                                    class="transition-colors hover:text-white duration-300 nc-Badge  inline-flex px-2.5 py-1 rounded-full font-medium text-xs !px-3 text-yellow-800 bg-yellow-100 hover:bg-yellow-800"
                                    href="/archive/the-demo-archive-slug">گربه ها</a></div>
                            <h1 class=" lg:text-neutral-100 text-neutral-900 font-semibold text-3xl md:!leading-[120%] dark:text-neutral-100 max-w-4xl "
                                title="Julio Urías does it all as Dodgers sweep in San Francisco">این یک ویدیویی تست است
                            </h1>
                                    ...
                                    <a class="flex items-center space-x-2 rtl:space-x-reverse"
                                        ...
                                        <div
                                            ...
                                            <img alt="Foulcher Nathanil" loading="lazy" decoding="async"
                                                ...
                                                src="@/assets/images/7.jpg"><span class="wil-avatar__name">F</span>
                                        </div>
                                    </a>
                                    <div class="ms-3">
                                        <div class="flex items-center"><a class="block font-semibold lg:text-neutral-100 text-neutral-900"
                                                href="/author/the-demo-author-slug">محبوب حسین زاده</a></div>
                                        <div class="text-xs mt-[6px]"><span
                                                class="lg:text-neutral-100 text-neutral-900 dark:text-neutral-300 font-fd">28 اردیبهست
                                                1403</span><span class="mx-2 font-semibold lg:text-neutral-100 text-neutral-900">·</span><span
                                                class="lg:text-neutral-100 text-neutral-900 dark:text-neutral-300">مطالعه دو دقیقه</span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="flex flex-row space-x-2.5 rtl:space-x-reverse items-center">
                                        <div
                                            ...
                                            <button
                                                ...
                                                title="Liked">
                                                <Like /><span
                                                    class="ml-1 text-neutral-900 dark:text-neutral-200">34</span>
                                            </button><a href="#comments"
                                                class="nc-PostCardCommentBtn relative items-center min-w-[68px] rounded-full text-neutral-6000 text-gray-800 bg-neutral-50 transition-colors dark:text-neutral-200 dark:bg-neutral-800 hover:bg-teal-50 dark:hover:bg-teal-100 hover:text-teal-600 dark:hover:text-teal-500 hidden sm:flex  px-4 h-9 text-sm "
                                                title="Comments">
                                                <Comment />
                                        ...
                                        <div class="px-1">
                                            ...
                                            class="nc-NcBookmark relative rounded-full flex items-center justify-center h-9 w-9 text-gray-900 bg-neutral-100 hover:bg-neutral-200 dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:text-neutral-200"
                ...
                <div class="relative lg:w-8/12 flex-shrink-0">
                    <div
                        class="aspect-w-16 aspect-h-16  aspect-h-9 border-4 border-neutral-300 dark:border-neutral-800 shadow-2xl bg-neutral-800 rounded-3xl overflow-hidden z-0">
                        <div>
    ...
    ReactDOM.render(element, document.getElementById('root'));
                    ...
                    <div class="max-w-screen-md mx-auto border-b border-t border-neutral-100 dark:border-neutral-700">
                    </div>
                                        ...
                                        <div
                                            ...
                                            <div class="py-4 px-6 md:py-5">
                                                <form action="#">
                                                    ...
                                                    <span class="text-sm">Are you sure you want to delete this comment?
                                                        You
