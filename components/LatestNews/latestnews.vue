            ...
            <div class="space-y-3">
              ...
              >
                ...
                ><span
                  ...
                  >·</span
                ><span
                  class="text-neutral-500 dark:text-neutral-400 font-normal"
          ...
          >
            ...
            <a
              ...
              ><img
                ...
                >
                  <span
                    class="bg-neutral-900/-60 rounded-full flex items-center justify-center text-xl text-white border border-white h-7 w-7"
                    ><svg
                      class="h-4 w-4"
                      viewBox="0 0 24 24"
                      fill="none"
