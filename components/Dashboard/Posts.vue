<template>
    <div class="posts border border-gray-200 dark:border-dark-700/20 rounded-lg card  dark:bg-dark-800 p-4">
        <div
            ...
            <div class="col-span-1 row-span-1 p-6 border rounded-lg dark:border-dark-700/20">
                <div class="flex items-start content-between justify-between">
                    <div class="content-left">
                        <span class="text-sm text-gray-500 dark:text-gray-300">تعداد نوشته ها</span>
            ...
            <div class="col-span-1 row-span-1 p-6 border rounded-lg dark:border-dark-700/20">
                <div class="flex items-start content-between justify-between">
                    <div class="content-left">
                        <span class="text-sm text-gray-500 dark:text-gray-300">تعداد پیش نویس</span>
                        <div class="flex items-center my-1">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <h6
                                        ...
                                        <i class="fa-light fa-grid-2 text-[20px] !w-5 !h-5 text-hamian ml-1"></i>نوشته
                                        ها
                                    </h6>
                                    <p
                                                ...
                                                <button
                                                    ...
                                                    <span
                                                        ...
                                                        class="relative z-20 flex items-center justify-center w-full text-center"><i
                                                            class="pl-2 text-2xl text-white fa-light fa-plus"></i><span
                                                            class="w-full">افزودن نوشته جدید</span></span>
                                                </button>
                                            </RouterLink>
                                        </div>
                                        ...
                                        <div class="min-w-full align-middle">
                                                                                                                ...
                                                                                                                <span
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        ...
                                                                                                                        <div
                                                                                                                            ...
                                                                                                                            <i
                                                                                                                                class="fa-light fa-trash-can text-[18px] !w-5 !h-5 font-normal"></i>
                                                                                                                        </div>
                                                                                                                        <RouterLink
                                                                                                                            to="/edit-news">
                                                                                                                            <div
                                                                                                                                class="w-4 ml-4 transform cursor-pointer hover:text-gray-500 hover:scale-110">
                                                                                                                                <i
                                                                                                                                    class="fa-light fa-edit text-[18px] !w-5 !h-5 font-normal"></i>
                                                                                                                            </div>
                                                                                                                        </RouterLink>
                                                                                                                        ...
                                                                                                                        <RouterLink
                                                                                                                            ...
                                                                                                                            <button
                                                                                                                                class="w-4 ml-4 transform cursor-pointer hover:text-gray-500 hover:scale-110">
                                                                                                                                <i
                                                                                                                                    class="fa-solid fa-eye text-[18px] !w-5 !h-5 font-normal"></i>
                                                                                                                            </button>
                                                                                                                        </RouterLink>
                                                                                                                    </div>
                                                                                                                </span>
                                            ...
                                            <div class="relative hidden overflow-x-auto lg:block Desktop-Table">
                                                    ...
                                                    <thead>
                                                        <tr
                                                            ...
                                                            <th scope="col"
                                                                ...
                                                                <input type="checkbox"
                                                                    class="absolute w-4 h-4 -mt-2 text-hamian border-gray-300 right-4 top-1/2 focus:ring-hamian sm:right-6 dark:bg-dark-900 dark:border-dark-700/20 dark:text-gray-300 dark:hover:bg-dark-700 dark:divide-dark-700/20" />
                                                            </th>

                                                            <th scope="col" v-for="(th, index) in cols" :key="th.field"
                                                                :class="th.size"
                                                    ...
                                                    <dataset-item tag="tbody"
                                                        ...
                                                        <template #default="{ row, rowIndex }">
                                                            <tr
                                                                ...
                                                                <td class="px-3 py-2 text-center">
                                                                    <div class="text-[15px] font-semibold">
                                                                        <span
                                                                            ...
                                                                            v-if="row.blogStatus == 0">در انتظار
                                                                            تایید</span>
                                                                        <span class="font-semibold text-gray-500"
                                                                            v-if="row.blogStatus == 1">پیش نویس</span>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td class="p-2 text-center mx-auto text-[15px] font-fd">
                                                                    {{ row.blogDate }}
                                                                </td>
                                                                ...
                                                                <td scope="col"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <i class="fa-light fa-trash-can text-[18px] !w-5 !h-5"
                                                                                :class="row.blogDelete"></i>
                                                                        </div>

                                                                        <RouterLink to="/edit-news">
                                                                            <div
                                                                                class="w-4 transform cursor-pointer hover:text-gray-500 hover:scale-110">
                                                                                <i class="fa-light fa-edit text-[18px] !w-5 !h-5"
                                                                                    :class="row.blogEdit"></i>
                                                                            </div>
                                                                        </RouterLink>
                                                ...
                                                <div
                                                    ...
                                                    <i
                                                        class="fa-light fa-empty-set flex-wrap font-semi-bold text-gray-300"></i>
