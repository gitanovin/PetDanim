    ...
    <div class="SingleHeader">
      <div class="space-y-5">
        ...
        <div
          ...
          <div
            ...
            <a class="flex items-center space-x-2 rtl:space-x-reverse" href="/author/the-demo-author-slug">
              <div
                ...
                <img alt="Foulcher Nathanil" class="absolute inset-0 w-full h-full object-cover"
                  src="@/assets/images/3.jpg" /><span class="wil-avatar__name">F</span>
              </div>
            </a>
            <div class="ms-3">
              <div class="flex items-center">
                <a class="block font-semibold" href="/author/the-demo-author-slug">محبوب حسین زاده</a>
              </div>
          ...
          <div class="SingleMetaAction">
            <div class="flex flex-row space-x-2.5 rtl:space-x-reverse items-center">
              <div class="PostCardLikeAndComment flex items-center  !space-x-2.5 rtl:!space-x-reverse">
                <LikeButton dark:hover:!bg-neutral-700 dark:!bg-dark-800 />
                <CommentButton />
              </div>
              <div class="px-1">
                <div class="border-s border-neutral-200 dark:border-neutral-700 h-6"></div>
              </div>
              <BookmarkButton class="h-9 w-9 dark:hover:!bg-neutral-700 dark:bg-dark-900" />

              <div class="relative inline-block text-left">
                <Menu as="div" class="relative inline-block text-left z-10">
                  <div>
                    <MenuButton
                      class="flex-shrink-0 flex items-center justify-center focus:outline-none h-9 w-9 bg-neutral-100 hover:bg-neutral-200 dark:hover:!bg-neutral-700 dark:bg-dark-800 text-neutral-700 dark:text-neutral-200 rounded-full">
                      <Share />
                    </MenuButton>
                  </div>
              ...
              <div>
                <div class="relative inline-block text-left">
                  <Menu as="div" class="relative inline-block text-left z-10">
                    <div>
                      <MenuButton
                        class="text-neutral-500 dark:text-neutral-400 flex items-center justify-center rounded-full h-9 w-9 bg-neutral-100 hover:bg-neutral-200 dark:hover:!bg-neutral-700 dark:bg-dark-800 focus:outline-none">
                        <MenuMoreIcon />
                      </MenuButton>
                    </div>
                      ...
                      <MenuItems
                        ...
                        <div class="px-2 py-4 space-y-2">
                          ...
                          <button :class="[
                            ...
                            <CopyIcon :active="active" class="ml-2 h-5 w-5 fill-gray-800" aria-hidden="true" />
                            کپی لینک مقاله
                          </button>
                          </MenuItem>
    ...
    <div class="relative grid grid-cols-3 sm:grid-cols-4 gap-2 my-10">
      <div class="col-span-2 row-span-2 relative rounded-xl overflow-hidden cursor-pointer z-0">
        <div class="absolute inset-0">
          <img alt="single" class="object-cover w-full h-full rounded-xl" src="@/assets/images/3.jpg" />
        </div>
      ...
      <div class="relative rounded-xl overflow-hidden z-0">
        <div class="aspect-w-6 aspect-h-5">
          <img alt="single" class="object-cover w-full h-full rounded-xl" src="@/assets/images/5.jpg" />
        </div>
        <div
          class="absolute inset-0 bg-neutral-900 bg-opacity-20 opacity-0 hover:opacity-100 transition-opacity cursor-pointer">
        </div>
      ...
      <div class="relative rounded-xl overflow-hidden z-0 hidden sm:block">
        <div class="aspect-w-6 aspect-h-5">
          <img alt="single" class="object-cover w-full h-full rounded-xl" src="@/assets/images/7.jpg" />
        </div>
        <div
          class="absolute inset-0 bg-neutral-900 bg-opacity-20 opacity-0 hover:opacity-100 transition-opacity cursor-pointer">
        </div>
      ...
      <div class="relative rounded-xl overflow-hidden z-0 hidden sm:block">
        <div class="aspect-w-6 aspect-h-5">
          <img alt="single" class="object-cover w-full h-full rounded-xl" src="@/assets/images/6.jpg" />
        </div>
        <div
          class="absolute inset-0 bg-neutral-900 bg-opacity-20 opacity-0 hover:opacity-100 transition-opacity cursor-pointer">
        </div>
      ...
      <div
        ...
        <GridIcon />
        <span class="ms-2 text-neutral-800 text-sm font-medium">مشاهده همه تصاویر</span>
      </div>
    </div>
  </header>
</template>
