<template>
  ...
  >
            ...
            <div class="col-span-12 font-fa">
              ...
              >
                ...
                >
                  ...
                  >
                    از این بخش میتوانید دنبال شونده های خود را مدیریت کنید
                  </p>
                </div>
                                ...
                                >
                                  <template #default="{ row, rowIndex }">
                                    ...
                                    >
                                      ...
                                      <div
                                        class="button"
                                        @click="openPromptModal(row.id)"
                                      >
                                        <button
                                          class="follow p-4 py-1 bg-transparent text-gray-700 border border-gray-400 rounded-full"
                                        >
                                          دنبال می کنید
                                        </button>
                                      </div>
    ...
    <promptModal
      ...
      title="هشدار"
      message="آیا میخواهید این کاربر از لیست دنبال شونده های شما حذف شود ؟ "
...
export default {
  ...
  methods: {
    ...
    async handleConfirm (){
        ...
        const result = await this.petdanimStore.removeUserFollowing({following_id: this.followingId})
        if(result.status == 200) {
            this.isLoading = false
            this.showPromptModal = false

            this.$emit('updateFollowings' , result.result)
