    ...
    >
      <span class="flex-shrink-0 h-5 w-5" aria-hidden="true">
        <Night
          ...
          class="text-xl h-5 w-5 dark:!fill-gray-50 dark:!text-gray-50 dark:!stroke-gray-50 stroke-nightbg"
        />
        <Sun
          v-else
          class="text-xl h-5 w-5 dark:!text-gray-50 dark:!stroke-gray-50 stroke-nightbg"
        />
      </span>
    </button>
  </div>
